...
const imgIcon = "/assets/icon-goal-achieved.png";
const imgTarget = "/assets/target-goal-achieved.png";
const imgBarbell = "/assets/barbell-goal-achieved.png";
const imgArrowsClockwise = "/assets/arrows-goal-achieved.png";
const imgPerson = "/assets/person-goal-achieved.png";
const imgMedal = "/assets/medal-goal-achieved.svg";
const imgVector = "/assets/vector-goal-achieved.svg";
const imgGroup = "/assets/group0-goal-achieved.png";
const imgGroup1 = "/assets/group1-goal-achieved.png";
const imgGroup2 = "/assets/group2-goal-achieved.png";
const imgGroup3 = "/assets/group3-goal-achieved.png";
const imgGroup4 = "/assets/group4-goal-achieved.png";
const imgGroup5 = "/assets/group5-goal-achieved.svg";
const imgGroup6 = "/assets/group6-goal-achieved.png";
const imgGroup7 = "/assets/group7-goal-achieved.png";
