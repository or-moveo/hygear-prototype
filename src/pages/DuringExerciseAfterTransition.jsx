...
const imgIcon = "https://www.figma.com/api/mcp/asset/892da9a5-5cfb-4672-8eaa-8e0353f2f69a";
const imgBarbell = "https://www.figma.com/api/mcp/asset/5abadafe-b105-4260-864c-71ff62a6c0fb";
const imgArrowsClockwise = "https://www.figma.com/api/mcp/asset/84b1ec75-185f-442a-b298-5d5baf965bf2";
const imgPerson = "https://www.figma.com/api/mcp/asset/a7940ccb-7d00-4606-bf61-6b23234dd17a";
const imgIcon1 = "https://www.figma.com/api/mcp/asset/fa5125a2-d95b-4cc6-928c-43e70a99ed40";
...
export default function StudioDashboardDuringTheExerciseAfterTransition() {
  return (
    <div className="bg-white relative size-full" data-name="Studio Dashboard — During the exercise (after transition)" data-node-id="376:6823">
      <div className="absolute content-stretch flex items-center justify-between left-0 p-[50px] top-0 w-[1920px]" data-name="Container" data-node-id="376:6829">
        <div className="h-[42px] relative shrink-0" data-name="Container" data-node-id="376:6830">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[16px] h-full items-center relative">
            <div className="h-[40px] relative shrink-0 w-[67px]" data-name="Habeasts_by_hygear_logo_2 1" data-node-id="376:6831">
            ...
            <p className="font-poppins font-semibold leading-[46px] not-italic relative shrink-0 text-[36px] text-black whitespace-nowrap" data-node-id="376:6832">
              Studio name
            </p>
          </div>
        </div>
      </div>
      <div className="absolute bg-white border-2 border-[#dddfe9] border-solid content-stretch flex flex-col gap-[16px] h-[882px] items-center justify-center left-[1500px] overflow-clip p-[26px] rounded-[16px] shadow-[0px_0px_16px_0px_rgba(0,0,0,0.06)] top-[142px] w-[370px]" data-name="Container" data-node-id="376:6833">
        <p className="font-poppins font-bold leading-[34px] not-italic relative shrink-0 text-[24px] text-black w-[328px]" data-node-id="376:6834">
          Training structure
        </p>
        <div className="flex-[828_0_0] min-h-px min-w-px relative w-[328px]" data-name="Container" data-node-id="376:6835">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[10px] items-start overflow-clip relative rounded-[inherit] size-full">
            <div className="bg-[#43a77c] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6836">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-white w-full whitespace-nowrap" data-node-id="376:6837">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6838">
                  Chest Press
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6839">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6840">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6841">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6842">
                  Static Launch Right
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6843">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6844">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6845">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6846">
                  Plank
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6847">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6848">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6849">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6850">
                  Crunch
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6851">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#dddfe9] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6852">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6853">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6854">
                  Abdominal
                </p>
                <p className="font-poppins font-normal leading-[24px] relative shrink-0 text-[16px]" dir="auto" data-node-id="376:6855">
                  5s
                </p>
              </div>
            </div>
            <div className="bg-[#edf3ef] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6856">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6857">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6858">
                  Take The Straps
                </p>
                <p className="font-poppins font-normal leading-[24px] relative shrink-0 text-[16px]" data-node-id="376:6859">
                  15s
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6860">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6861">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6862">
                  Fly
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6863">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6864">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6865">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6866">
                  Back Fly
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6867">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6868">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6869">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6870">
                  Triceps
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6871">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6872">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6873">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6874">
                  Biceps Curl
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6875">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6876">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6877">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6878">
                  Shoulder Extension
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6879">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6880">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6881">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6882">
                  Shoulder Extension
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6883">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#f8f7f7] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6884">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6885">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6886">
                  Shoulder Flexion
                </p>
                <p className="font-poppins font-normal leading-[0] relative shrink-0 text-[0px]" data-node-id="376:6887">
                  <span className="leading-[24px] text-[16px]">45s/</span>
                  <span className="font-poppins font-semibold leading-[24px] text-[16px]">15s</span>
                </p>
              </div>
            </div>
            <div className="bg-[#dddfe9] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6888">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6889">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6890">
                  Abdominal
                </p>
                <p className="font-poppins font-normal leading-[24px] relative shrink-0 text-[16px]" dir="auto" data-node-id="376:6891">
                  5s
                </p>
              </div>
            </div>
            <div className="bg-[#edf3ef] content-stretch flex flex-col items-start p-[12px] relative rounded-[10px] shrink-0 w-[328px]" data-name="Container" data-node-id="376:6892">
              <div className="content-stretch flex items-center justify-between not-italic relative shrink-0 text-black w-full whitespace-nowrap" data-node-id="376:6893">
                <p className="font-poppins font-semibold leading-[28px] relative shrink-0 text-[18px]" data-node-id="376:6894">
                  Take The Straps
                </p>
                <p className="font-poppins font-normal leading-[24px] relative shrink-0 text-[16px]" data-node-id="376:6895">
                  15s
                </p>
              </div>
            </div>
