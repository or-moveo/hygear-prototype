      ...
      <div className="absolute content-stretch flex items-center justify-between left-0 p-[50px] top-0 w-[1920px]" data-name="Container" data-node-id="376:8908">
        <div className="h-[42px] relative shrink-0" data-name="Container" data-node-id="376:8909">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[16px] h-full items-center relative">
            <div className="h-[40px] relative shrink-0 w-[67px]" data-name="Habeasts_by_hygear_logo_2 1" data-node-id="376:8910">
            ...
            <p className="font-poppins font-semibold leading-[46px] not-italic relative shrink-0 text-[36px] text-black whitespace-nowrap" data-node-id="376:8911">
              Studio name
            </p>
          </div>
        </div>
