...
export default function DemoPrepVideo() {
    ...
    <ScaledFrame>
      <StageBackground variant="dark" showTopbar>
        ...
        <div style={{ position: 'absolute', left: 50, top: 142, width: 1820, height: 888, zIndex: 5 }}>
          ...
          {/* Header: Logo box (317x180) + Title bar (1479x180) */}
          <div style={{
          ...
          {/* Single big white card: 1820x684 at top:204, full radius 36/18/36/36 */}
          <div style={{
            position: 'absolute', left: 0, top: 204,
            width: 1820, height: 684,
            background: '#fff',
            borderRadius: '36px 18px 36px 36px',
            overflow: 'hidden',
          }}>
            {/* Video (object-contain to avoid cropping) */}
            <VideoPlayer src={EXERCISE.video} className="!object-contain" />

            {/* Number badge: 66x66, green, top-left, radius 12/0/12/0 */}
            <div style={{
              position: 'absolute', left: 0, top: 0,
              width: 66, height: 66,
              background: GREEN_SOLID,
            ...
            {/* Reps pill: 212x70 at left:16, top:598, radius 12/6/12/12 */}
            <div style={{
              position: 'absolute', left: 16, top: 598,
              width: 212, height: 70,
              padding: '12px 16px',
              gap: 12,
              ...
              <ArrowClockwise size={42} color="#fff" weight="bold" />
              <span style={{
                fontFamily: 'Poppins, sans-serif', fontWeight: 600, fontSize: 36, lineHeight: '46px',
                color: '#fff',
