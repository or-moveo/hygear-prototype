...
export default function AthleteCard({ name, bpm, reps, kg, connected }) {
  ...
  return (
    <div
      className="p-4 flex flex-col justify-between h-full min-h-[200px]"
      style={{ background: bg, borderRadius: '36px 18px 36px 36px' }}
    >
      ...
      <div className="flex items-center">
        ...
        <div
          className="shrink-0 font-poppins font-bold"
          style={{ background: 'rgba(0,0,0,0.35)', color: '#fff', letterSpacing: '0.08em', padding: '3px 11px', fontSize: 14, lineHeight: '20px', borderRadius: '36px 18px 36px 36px' }}
        >
          ZONE {zone.id}
        </div>
      ...
      <div className="flex gap-4 mt-3">
        <div
          className="bg-white flex-1 shadow-[0px_0px_16px_0px_rgba(0,0,0,0.06)] flex flex-col items-center justify-center gap-1 py-4"
